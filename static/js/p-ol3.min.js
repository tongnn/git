...
goog.global = this, goog.global.CLOSURE_UNCOMPILED_DEFINES, goog.global.CLOSURE_DEFINES, goog.isDef = function(t) {
...
}, goog.basePath = "", goog.global.CLOSURE_BASE_PATH, goog.global.CLOSURE_NO_DEPS, goog.global.CLOSURE_IMPORT_SCRIPT, goog.nullFunction = function() {}, goog.identityFunction = function(t, o) {
	return t
	...
	if(goog.inHtmlDocument_())
		for(var t = goog.global.document, o = t.getElementsByTagName("script"), e = o.length - 1; e >= 0; --e) {
			var r = o[e].src,
				n = r.lastIndexOf("?"),
				g = -1 == n ? r.length : n;
	...
	try {
		...
		if(goog.moduleLoaderState_.declareLegacyNamespace ? goog.constructNamespace_(e, o) : goog.SEAL_MODULE_EXPORTS && Object.seal && Object.seal(o), goog.loadedModules_[e] = o, goog.moduleLoaderState_.declareTestMethods)
			for(var r in o)(0 === r.indexOf("test", 0) || "tearDown" == r || "setup" == r) && (goog.global[r] = o[r])
	} finally {
	...
	for(var n = Array.prototype.slice.call(arguments, 2), g = !1, i = t.constructor; i; i = i.superClass_ && i.superClass_.constructor)
		if(i.prototype[o] === r) g = !0;
...
}, goog.UNSEALABLE_CONSTRUCTOR_PROPERTY_ = "goog_defineClass_legacy_unsealable", goog.provide("goog.disposable.IDisposable"), goog.disposable.IDisposable = function() {}, goog.disposable.IDisposable.prototype.dispose = goog.abstractMethod, goog.disposable.IDisposable.prototype.isDisposed = goog.abstractMethod, goog.provide("goog.Disposable"), goog.provide("goog.dispose"), goog.provide("goog.disposeAll"), goog.require("goog.disposable.IDisposable"), goog.Disposable = function() {
	...
	NOTATION: 12
}, goog.provide("goog.string"), goog.provide("goog.string.Unicode"), goog.define("goog.string.DETECT_DOUBLE_ESCAPING", !1), goog.string.Unicode = {
	NBSP: " "
	...
	for(var e = 0, r = goog.string.trim(String(t)).split("."), n = goog.string.trim(String(o)).split("."), g = Math.max(r.length, n.length), i = 0; 0 == e && g > i; i++) {
		...
		do {
			...
			var p = 0 == c[1].length ? 0 : parseInt(c[1], 10),
	...
	for(var r = t.length, n = [], g = 0, i = goog.isString(t) ? t.split("") : t, s = 0; r > s; s++)
		if(s in i) {
			var a = i[s];
	...
	for(var r = t.length, n = goog.isString(t) ? t.split("") : t, g = 0; r > g; g++)
		if(g in n && o.call(e, n[g], g, t)) return !0;
	return !1
	...
	for(var r = t.length, n = goog.isString(t) ? t.split("") : t, g = 0; r > g; g++)
		if(g in n && !o.call(e, n[g], g, t)) return !1;
	return !0
	...
	if(!goog.isArray(t))
		for(var o = t.length - 1; o >= 0; o--) delete t[o];
	t.length = 0
	...
	for(var e = 1; e < arguments.length; e++) {
		...
		if(goog.isArray(n) || (r = goog.isArrayLike(n)) && Object.prototype.hasOwnProperty.call(n, "callee")) t.push.apply(t, n);
			...
			for(var g = t.length, i = n.length, s = 0; i > s; s++) t[g + s] = n[s];
		else t.push(n)
	}
	...
	for(var r = t.length, n = e || goog.array.defaultCompareEquality, g = 0; r > g; g++)
		if(!n(t[g], o[g])) return !1;
	return !0
	...
	if(i > 0)
		for(var s = n; g > s; s += i) r.push(s);
	else
		for(var s = n; s > g; s += i) r.push(s);
	return r
	...
	for(var r in t)
		if(o.call(e, t[r], r, t)) return !0;
	return !1
}, goog.object.every = function(t, o, e) {
	for(var r in t)
		if(!o.call(e, t[r], r, t)) return !1;
	return !0
	...
	return this.event_
}, goog.events.BrowserEvent.prototype.disposeInternal = function() {}, goog.provide("goog.debug.EntryPointMonitor"), goog.provide("goog.debug.entryPointRegistry"), goog.require("goog.asserts"), goog.debug.EntryPointMonitor = function() {}, goog.debug.EntryPointMonitor.prototype.wrap, goog.debug.EntryPointMonitor.prototype.unwrap, goog.debug.entryPointRegistry.refList_ = [], goog.debug.entryPointRegistry.monitors_ = [], goog.debug.entryPointRegistry.monitorsMayExist_ = !1, goog.debug.entryPointRegistry.register = function(t) {
	if(goog.debug.entryPointRegistry.refList_[goog.debug.entryPointRegistry.refList_.length] = t, goog.debug.entryPointRegistry.monitorsMayExist_)
		for(var o = goog.debug.entryPointRegistry.monitors_, e = 0; e < o.length; e++) t(goog.bind(o[e].wrap, o[e]))
	...
	o.length--
}, goog.provide("goog.events.Listenable"), goog.provide("goog.events.ListenableKey"), goog.require("goog.events.EventId"), goog.events.Listenable = function() {}, goog.events.Listenable.IMPLEMENTED_BY_PROP = "closure_listenable_" + (1e6 * Math.random() | 0), goog.events.Listenable.addImplementation = function(t) {
	...
	return goog.object.some(this.listeners, function(t, g) {
		for(var i = 0; i < t.length; ++i)
			if(!(e && t[i].type != r || n && t[i].capture != o)) return !0;
		return !1
	})
	...
	var r = 0,
		n = o && o.toString();
	for(var g in e.listeners)
		if(!n || g == n)
			for(var i = e.listeners[g].concat(), s = 0; s < i.length; ++s) goog.events.unlistenByKey(i[s]) && ++r;
	return r
...
"object" == typeof module && "object" == typeof module.exports ? module.exports = P : "function" == typeof define && define.amd && define(P), "undefined" != typeof window && expose(), P.Constants = {
	TWO_PI: 2 * Math.PI,
	HALF_PI: Math.PI / 2,
	FITTING_COUNT: 100,
	ZERO_TOLERANCE: 1e-4
	...
	_stampId: 0
}, P.Utils.trim = function(t) {
	return t.trim ? t.trim() : t.replace(/^\s+|\s+$/g, "")
}, P.Utils.stamp = function(t) {
	var o = "_p_id_";
	return t[o] = t[o] || this._stampId++, t[o]
}, P.DomUtils = {}, P.DomUtils.create = function(t, o, e, r) {
	var n = document.createElement(t);
	return n.className = o || "", r && (n.id = r), e && e.appendChild(n), n
}, P.DomUtils.createHidden = function(t, o, e) {
	var r = document.createElement(t);
	return r.style.display = "none", e && (r.id = e), o && o.appendChild(r), r
}, P.DomUtils.remove = function(t, o) {
	o && t && o.removeChild(t)
}, P.DomUtils.get = function(t) {
	return document.getElementById(t)
}, P.DomUtils.getStyle = function(t, o) {
	var e = t.style[o];
	return "auto" === e ? null : e
}, P.DomUtils.hasClass = function(t, o) {
	return t.className.length > 0 && new RegExp("(^|\\s)" + o + "(\\s|$)").test(t.className)
}, P.DomUtils.addClass = function(t, o) {
	this.hasClass(t, o) || (t.className && (t.className += " "), t.className += o)
}, P.DomUtils.removeClass = function(t, o) {
	t.className = P.Utils.trim((" " + t.className + " ").replace(" " + o + " ", " "))
}, P.DomUtils.getDomEventKey = function(t, o, e) {
	return "_p_dom_event_" + t + "_" + P.Utils.stamp(o) + (e ? "_" + P.Utils.stamp(e) : "")
}, P.DomUtils.addListener = function(t, o, e, r) {
	var n = this,
		g = P.DomUtils.getDomEventKey(o, e, r),
		i = t[g];
	return i ? n : (i = function(o) {
		return e.call(r || t, o)
	}, "addEventListener" in t ? t.addEventListener(o, i, !1) : "attachEvent" in t && t.attachEvent("on" + o, i), t[g] = i, n)
}, P.DomUtils.removeListener = function(t, o, e, r) {
	var n = this,
		g = P.DomUtils.getDomEventKey(o, e, r),
		i = t[g];
	return i ? ("removeEventListener" in t ? t.removeEventListener(o, i, !1) : "detachEvent" in t && t.detachEvent("on" + o, i), t[g] = null, n) : n
}, P.PlotTypes = {
	ARC: "arc",
	ELLIPSE: "ellipse",
	CURVE: "curve",
...
}, P.Event = {}, P.Event.EventType = {}, P.Event.EventType.MOUSEMOVE = "mousemove", P.Event.EventType.MOUSEUP = "mouseup", P.Event.EventType.MOUSEDOWN = "mousedown", P.Event.PlotDrawEvent = function(t, o) {
	goog.base(this, t), this.feature = o
}, goog.inherits(P.Event.PlotDrawEvent, goog.events.Event), P.Event.PlotDrawEvent.DRAW_START = "draw_start", P.Event.PlotDrawEvent.DRAW_END = "draw_end", P.Plot = function(t) {
	this.setPoints(t)
}, P.Plot.prototype = {
	isPlot: function() {
		return !0
	...
	setPoints: function(t) {
		this.points = t ? t : [], this.points.length >= 1 && this.generate()
	},
	getPoints: function() {
	...
	updatePoint: function(t, o) {
		o >= 0 && o < this.points.length && (this.points[o] = t, this.generate())
	},
	updateLastPoint: function(t) {
		this.updatePoint(t, this.points.length - 1)
	},
	generate: function() {},
	finishDrawing: function() {}
}, P.Plot.Arc = function(t) {
	goog.base(this, []), this.type = P.PlotTypes.ARC, this.fixPointCount = 3, this.setPoints(t)
}, goog.inherits(P.Plot.Arc, ol.geom.LineString), goog.mixin(P.Plot.Arc.prototype, P.Plot.prototype), P.Plot.Arc.prototype.generate = function() {
	var t = this.getPointCount();
	if(!(2 > t))
		if(2 == t) this.setCoordinates(this.points);
		else {
			var o = this.points[0],
				e = this.points[1],
				r = this.points[2],
				n = P.PlotUtils.getCircleCenterOfThreePoints(o, e, r),
				g = P.PlotUtils.distance(o, n),
				i = P.PlotUtils.getAzimuth(o, n),
				s = P.PlotUtils.getAzimuth(e, n);
			if(P.PlotUtils.isClockWise(o, e, r)) var a = s,
				l = i;
			else a = i, l = s;
			this.setCoordinates(P.PlotUtils.getArcPoints(n, g, a, l))
		}
}, P.Plot.AttackArrow = function(t) {
	goog.base(this, []), this.type = P.PlotTypes.ATTACK_ARROW, this.headHeightFactor = .18, this.headWidthFactor = .3, this.neckHeightFactor = .85, this.neckWidthFactor = .15, this.headTailFactor = .8, this.setPoints(t)
}, goog.inherits(P.Plot.AttackArrow, ol.geom.Polygon), goog.mixin(P.Plot.AttackArrow.prototype, P.Plot.prototype), P.Plot.AttackArrow.prototype.generate = function() {
	if(!(this.getPointCount() < 2)) {
		if(2 == this.getPointCount()) return void this.setCoordinates([this.points]);
		var t = this.getPoints(),
			o = t[0],
			e = t[1];
		P.PlotUtils.isClockWise(t[0], t[1], t[2]) && (o = t[1], e = t[0]);
		var r = P.PlotUtils.mid(o, e),
			n = [r].concat(t.slice(2)),
			g = this.getArrowHeadPoints(n, o, e),
			i = g[0],
			s = g[4],
			a = P.PlotUtils.distance(o, e) / P.PlotUtils.getBaseLength(n),
			l = this.getArrowBodyPoints(n, i, s, a),
			u = l.length,
			c = [o].concat(l.slice(0, u / 2));
		c.push(i);
		var p = [e].concat(l.slice(u / 2, u));
		p.push(s), c = P.PlotUtils.getQBSplinePoints(c), p = P.PlotUtils.getQBSplinePoints(p), this.setCoordinates([c.concat(g, p.reverse())])
	}
}, P.Plot.AttackArrow.prototype.getArrowHeadPoints = function(t, o, e) {
	...
	return [d, p, g, h, f]
}, P.Plot.AttackArrow.prototype.getArrowBodyPoints = function(t, o, e, r) {
	...
	return u.concat(c)
}, P.Plot.SquadCombat = function(t) {
	goog.base(this, []),
		this.type = P.PlotTypes.SQUAD_COMBAT,
		this.headHeightFactor = .08,
		this.headWidthFactor = .2,
		this.neckHeightFactor = .85,
		this.neckWidthFactor = .075,
		this.tailWidthFactor = .03,
		this.setPoints(t)
}, goog.inherits(P.Plot.SquadCombat, P.Plot.AttackArrow), P.Plot.SquadCombat.prototype.generate = function() {
	var t = this.getPointCount();
	if(!(2 > t)) {
		var o = this.getPoints(),
			e = this.getTailPoints(o),
			r = this.getArrowHeadPoints(o, e[0], e[1]),
			n = r[0],
			g = r[4],
			i = this.getArrowBodyPoints(o, n, g, this.tailWidthFactor),
			t = i.length,
			s = [e[0]].concat(i.slice(0, t / 2));
		s.push(n);
		var a = [e[1]].concat(i.slice(t / 2, t));
		a.push(g), s = P.PlotUtils.getQBSplinePoints(s), a = P.PlotUtils.getQBSplinePoints(a), this.setCoordinates([s.concat(r, a.reverse())])
	}
}, P.Plot.SquadCombat.prototype.getTailPoints = function(t) {
	var o = P.PlotUtils.getBaseLength(t),
		e = o * this.tailWidthFactor,
		r = P.PlotUtils.getThirdPoint(t[1], t[0], P.Constants.HALF_PI, e, !1),
		n = P.PlotUtils.getThirdPoint(t[1], t[0], P.Constants.HALF_PI, e, !0);
	return [r, n]
}, P.Plot.TailedAttackArrow = function(t) {
	goog.base(this, []), this.type = P.PlotTypes.TAILED_ATTACK_ARROW, this.headHeightFactor = .18, this.headWidthFactor = .3, this.neckHeightFactor = .85, this.neckWidthFactor = .15, this.tailWidthFactor = .1, this.headTailFactor = .8, this.swallowTailFactor = 1, this.swallowTailPnt = null, this.setPoints(t)
}, goog.inherits(P.Plot.TailedAttackArrow, P.Plot.AttackArrow), P.Plot.TailedAttackArrow.prototype.generate = function() {
	var t = this.getPointCount();
	if(!(2 > t)) {
		if(2 == this.getPointCount()) return void this.setCoordinates([this.points]);
		var o = this.getPoints(),
		...
		var n = P.PlotUtils.mid(e, r),
			...
			i = this.getArrowHeadPoints(g, e, r),
			s = i[0],
			a = i[4],
			l = P.PlotUtils.distance(e, r),
		...
		var p = l / u,
			h = this.getArrowBodyPoints(g, s, a, p),
			t = h.length,
			d = [e].concat(h.slice(0, t / 2));
		d.push(s);
		var f = [r].concat(h.slice(t / 2, t));
		f.push(a), d = P.PlotUtils.getQBSplinePoints(d), f = P.PlotUtils.getQBSplinePoints(f), this.setCoordinates([d.concat(i, f.reverse(), [this.swallowTailPnt, d[0]])])
	}
}, P.Plot.TailedSquadCombat = function(t) {
	goog.base(this, []), this.type = P.PlotTypes.TAILED_SQUAD_COMBAT, this.headHeightFactor = .18, this.headWidthFactor = .3, this.neckHeightFactor = .85, this.neckWidthFactor = .15, this.tailWidthFactor = .1, this.swallowTailFactor = 1, this.swallowTailPnt = null, this.setPoints(t)
}, goog.inherits(P.Plot.TailedSquadCombat, P.Plot.AttackArrow), P.Plot.TailedSquadCombat.prototype.generate = function() {
	var t = this.getPointCount();
	if(!(2 > t)) {
		var o = this.getPoints(),
			e = this.getTailPoints(o),
			r = this.getArrowHeadPoints(o, e[0], e[2]),
			n = r[0],
			g = r[4],
			i = this.getArrowBodyPoints(o, n, g, this.tailWidthFactor),
			t = i.length,
		...
		a.push(g), s = P.PlotUtils.getQBSplinePoints(s), a = P.PlotUtils.getQBSplinePoints(a), this.setCoordinates([s.concat(r, a.reverse(), [e[1], s[0]])])
	}
}, P.Plot.TailedSquadCombat.prototype.getTailPoints = function(t) {
	var o = P.PlotUtils.getBaseLength(t),
		e = o * this.tailWidthFactor,
		r = P.PlotUtils.getThirdPoint(t[1], t[0], P.Constants.HALF_PI, e, !1),
		n = P.PlotUtils.getThirdPoint(t[1], t[0], P.Constants.HALF_PI, e, !0),
		g = e * this.swallowTailFactor,
		i = P.PlotUtils.getThirdPoint(t[1], t[0], 0, g, !0);
	return [r, i, n]
}, P.Plot.Circle = function(t) {
	goog.base(this, []), this.type = P.PlotTypes.CIRCLE, this.fixPointCount = 2, this.setPoints(t)
}, goog.inherits(P.Plot.Circle, ol.geom.Polygon), goog.mixin(P.Plot.Circle.prototype, P.Plot.prototype), P.Plot.Circle.prototype.generate = function() {
	var t = this.getPointCount();
	if(!(2 > t)) {
		var o = this.points[0],
			e = P.PlotUtils.distance(o, this.points[1]);
		this.setCoordinates([this.generatePoints(o, e)])
	}
}, P.Plot.Circle.prototype.generatePoints = function(t, o) {
	for(var e, r, n, g = [], i = 0; i <= P.Constants.FITTING_COUNT; i++) n = 2 * Math.PI * i / P.Constants.FITTING_COUNT, e = t[0] + o * Math.cos(n), r = t[1] + o * Math.sin(n), g.push([e, r]);
	return g
}, P.Plot.ClosedCurve = function(t) {
	goog.base(this, []), this.type = P.PlotTypes.CLOSED_CURVE, this.t = .3, this.setPoints(t)
}, goog.inherits(P.Plot.ClosedCurve, ol.geom.Polygon), goog.mixin(P.Plot.ClosedCurve.prototype, P.Plot.prototype), P.Plot.ClosedCurve.prototype.generate = function() {
	var t = this.getPointCount();
	if(!(2 > t))
		if(2 == t) this.setCoordinates([this.points]);
		else {
			var o = this.getPoints();
			o.push(o[0], o[1]);
			for(var e = [], r = 0; r < o.length - 2; r++) {
				var n = P.PlotUtils.getBisectorNormals(this.t, o[r], o[r + 1], o[r + 2]);
				e = e.concat(n)
			}
			var t = e.length;
			e = [e[t - 1]].concat(e.slice(0, t - 1));
			var g = [];
			for(r = 0; r < o.length - 2; r++) {
				var i = o[r],
					s = o[r + 1];
				g.push(i);
				for(var a = 0; a <= P.Constants.FITTING_COUNT; a++) {
					var l = P.PlotUtils.getCubicValue(a / P.Constants.FITTING_COUNT, i, e[2 * r], e[2 * r + 1], s);
					g.push(l)
				}
				g.push(s)
			}
...
}, P.Plot.Curve = function(t) {
	goog.base(this, []), this.type = P.PlotTypes.CURVE, this.t = .3, this.setPoints(t)
}, goog.inherits(P.Plot.Curve, ol.geom.LineString), goog.mixin(P.Plot.Curve.prototype, P.Plot.prototype), P.Plot.Curve.prototype.generate = function() {
	var t = this.getPointCount();
	2 > t || (2 == t ? this.setCoordinates(this.points) : this.setCoordinates(P.PlotUtils.getCurvePoints(this.t, this.points)))
}, P.Plot.DoubleArrow = function(t) {
	goog.base(this, []), this.type = P.PlotTypes.DOUBLE_ARROW, this.headHeightFactor = .25, this.headWidthFactor = .3, this.neckHeightFactor = .85, this.neckWidthFactor = .15, this.connPoint = null, this.tempPoint4 = null, this.fixPointCount = 4, this.setPoints(t)
}, goog.inherits(P.Plot.DoubleArrow, ol.geom.Polygon), goog.mixin(P.Plot.DoubleArrow.prototype, P.Plot.prototype), P.Plot.DoubleArrow.prototype.finishDrawing = function() {
	...
	var t = this.getPointCount();
	if(!(2 > t)) {
		if(2 == t) return void this.setCoordinates([this.points]);
		var o = this.points[0],
			e = this.points[1],
			r = this.points[2],
			t = this.getPointCount();
		3 == t ? this.tempPoint4 = this.getTempPoint4(o, e, r) : this.tempPoint4 = this.points[3], 3 == t || 4 == t ? this.connPoint = P.PlotUtils.mid(o, e) : this.connPoint = this.points[4];
		var n, g;
		P.PlotUtils.isClockWise(o, e, r) ? (n = this.getArrowPoints(o, this.connPoint, this.tempPoint4, !1), g = this.getArrowPoints(this.connPoint, e, r, !0)) : (n = this.getArrowPoints(e, this.connPoint, r, !1), g = this.getArrowPoints(this.connPoint, o, this.tempPoint4, !0));
		var i = n.length,
			s = (i - 5) / 2,
			a = n.slice(0, s),
			l = n.slice(s, s + 5),
...
}, P.Plot.DoubleArrow.prototype.getArrowPoints = function(t, o, e, r) {
...
}, P.Plot.DoubleArrow.prototype.getArrowHeadPoints = function(t, o, e) {
	var r = P.PlotUtils.getBaseLength(t),
		n = r * this.headHeightFactor,
		g = t[t.length - 1],
	...
	return [h, c, g, p, d]
}, P.Plot.DoubleArrow.prototype.getArrowBodyPoints = function(t, o, e, r) {
	for(var n = P.PlotUtils.wholeDistance(t), g = P.PlotUtils.getBaseLength(t), i = g * r, s = P.PlotUtils.distance(o, e), a = (i - s) / 2, l = 0, u = [], c = [], p = 1; p < t.length - 1; p++) {
		var h = P.PlotUtils.getAngleOfThreePoints(t[p - 1], t[p], t[p + 1]) / 2;
		l += P.PlotUtils.distance(t[p - 1], t[p]);
		var d = (i / 2 - l / n * a) / Math.sin(h),
	...
	return u.concat(c)
}, P.Plot.DoubleArrow.prototype.getTempPoint4 = function(t, o, e) {
...
}, P.Plot.Ellipse = function(t) {
	goog.base(this, []), this.type = P.PlotTypes.ELLIPSE, this.fixPointCount = 2, this.setPoints(t)
}, goog.inherits(P.Plot.Ellipse, ol.geom.Polygon), goog.mixin(P.Plot.Ellipse.prototype, P.Plot.prototype), P.Plot.Ellipse.prototype.generate = function() {
	var t = this.getPointCount();
	if(!(2 > t)) {
		var o = this.points[0],
			e = this.points[1],
			r = P.PlotUtils.mid(o, e),
			n = Math.abs((o[0] - e[0]) / 2),
			g = Math.abs((o[1] - e[1]) / 2);
		this.setCoordinates([this.generatePoints(r, n, g)])
	}
}, P.Plot.Ellipse.prototype.generatePoints = function(t, o, e) {
	for(var r, n, g, i = [], s = 0; s <= P.Constants.FITTING_COUNT; s++) g = 2 * Math.PI * s / P.Constants.FITTING_COUNT, r = t[0] + o * Math.cos(g), n = t[1] + e * Math.sin(g), i.push([r, n]);
	return i
}, P.Plot.FineArrow = function(t) {
	goog.base(this, []), this.type = P.PlotTypes.FINE_ARROW,
		this.tailWidthFactor = 0.04, this.neckWidthFactor = 0.08, this.headWidthFactor = 0.1,
		this.headAngle = Math.PI / 8.5, this.neckAngle = Math.PI / 13, this.fixPointCount = 2, this.setPoints(t)
}, goog.inherits(P.Plot.FineArrow, ol.geom.Polygon), goog.mixin(P.Plot.FineArrow.prototype, P.Plot.prototype), P.Plot.FineArrow.prototype.generate = function() {
	var t = this.getPointCount();
	if(!(2 > t)) {
		var o = this.getPoints(),
			e = o[0],
			...
			g = n * this.tailWidthFactor,
			i = n * this.neckWidthFactor,
			...
			u = P.PlotUtils.getThirdPoint(e, r, this.headAngle, s, !1),
			c = P.PlotUtils.getThirdPoint(e, r, this.headAngle, s, !0),
			p = P.PlotUtils.getThirdPoint(e, r, this.neckAngle, i, !1),
			h = P.PlotUtils.getThirdPoint(e, r, this.neckAngle, i, !0),
			d = [a, p, u, r, c, h, l];
		this.setCoordinates([d])
	}
}, P.Plot.AssaultDirection = function(t) {
	goog.base(this, []), this.type = P.PlotTypes.ASSAULT_DIRECTION, this.tailWidthFactor = .2, this.neckWidthFactor = .25, this.headWidthFactor = .3, this.headAngle = Math.PI / 4, this.neckAngle = .17741 * Math.PI, this.setPoints(t)
}, goog.inherits(P.Plot.AssaultDirection, P.Plot.FineArrow), P.Plot.GatheringPlace = function(t) {
	goog.base(this, []), this.type = P.PlotTypes.GATHERING_PLACE, this.t = .4, this.fixPointCount = 3, this.setPoints(t)
}, goog.inherits(P.Plot.GatheringPlace, ol.geom.Polygon), goog.mixin(P.Plot.GatheringPlace.prototype, P.Plot.prototype), P.Plot.GatheringPlace.prototype.generate = function() {
	var t = this.getPoints();
	if(!(t.length < 2)) {
		if(2 == this.getPointCount()) {
			var o = P.PlotUtils.mid(t[0], t[1]),
				e = P.PlotUtils.distance(t[0], o) / .9,
				r = P.PlotUtils.getThirdPoint(t[0], o, P.Constants.HALF_PI, e, !0);
			t = [t[0], r, t[1]]
		}
		var o = P.PlotUtils.mid(t[0], t[2]);
		t.push(o, t[0], t[1]);
		for(var n = [], g = 0; g < t.length - 2; g++) {
			var i = t[g],
				s = t[g + 1],
				a = t[g + 2],
				l = P.PlotUtils.getBisectorNormals(this.t, i, s, a);
			n = n.concat(l)
		}
		var u = n.length;
		n = [n[u - 1]].concat(n.slice(0, u - 1));
		var c = [];
		for(g = 0; g < t.length - 2; g++) {
			i = t[g], s = t[g + 1], c.push(i);
			for(var p = 0; p <= P.Constants.FITTING_COUNT; p++) {
				var r = P.PlotUtils.getCubicValue(p / P.Constants.FITTING_COUNT, i, n[2 * g], n[2 * g + 1], s);
				c.push(r)
			}
			c.push(s)
		}
...
}, P.Plot.Lune = function(t) {
	goog.base(this, []), this.type = P.PlotTypes.LUNE, this.fixPointCount = 3, this.setPoints(t)
}, goog.inherits(P.Plot.Lune, ol.geom.Polygon), goog.mixin(P.Plot.Lune.prototype, P.Plot.prototype), P.Plot.Lune.prototype.generate = function() {
	if(!(this.getPointCount() < 2)) {
		var t = this.getPoints();
		if(2 == this.getPointCount()) {
			var o = P.PlotUtils.mid(t[0], t[1]),
				e = P.PlotUtils.distance(t[0], o),
				r = P.PlotUtils.getThirdPoint(t[0], o, P.Constants.HALF_PI, e);
			t.push(r)
		}
		var n = t[0],
			g = t[1],
			i = t[2],
			s = P.PlotUtils.getCircleCenterOfThreePoints(n, g, i),
			a = P.PlotUtils.distance(n, s),
			l = P.PlotUtils.getAzimuth(n, s),
			u = P.PlotUtils.getAzimuth(g, s);
		if(P.PlotUtils.isClockWise(n, g, i)) var c = u,
			p = l;
		else c = l, p = u;
		var t = P.PlotUtils.getArcPoints(s, a, c, p);
		t.push(t[0]), this.setCoordinates([t])
	}
}, P.Plot.Sector = function(t) {
	goog.base(this, []), this.type = P.PlotTypes.SECTOR, this.fixPointCount = 3, this.setPoints(t)
}, goog.inherits(P.Plot.Sector, ol.geom.Polygon), goog.mixin(P.Plot.Sector.prototype, P.Plot.prototype), P.Plot.Sector.prototype.generate = function() {
	if(!(this.getPointCount() < 2))
		if(2 == this.getPointCount()) this.setCoordinates([this.points]);
		else {
			var t = this.getPoints(),
				o = t[0],
				e = t[1],
				r = t[2],
				n = P.PlotUtils.distance(e, o),
				g = P.PlotUtils.getAzimuth(e, o),
				i = P.PlotUtils.getAzimuth(r, o),
				s = P.PlotUtils.getArcPoints(o, n, g, i);
			s.push(o, s[0]), this.setCoordinates([s])
		}
}, P.Plot.StraightArrow = function(t) {
	goog.base(this, []), this.type = P.PlotTypes.STRAIGHT_ARROW, this.fixPointCount = 2, this.maxArrowLength = 3e6, this.arrowLengthScale = 5, this.setPoints(t)
}, goog.inherits(P.Plot.StraightArrow, ol.geom.LineString), goog.mixin(P.Plot.StraightArrow.prototype, P.Plot.prototype), P.Plot.StraightArrow.prototype.generate = function() {
	if(!(this.getPointCount() < 2)) {
		var t = this.getPoints(),
			o = t[0],
			e = t[1],
			r = P.PlotUtils.distance(o, e),
			n = r / this.arrowLengthScale;
		n = n > this.maxArrowLength ? this.maxArrowLength : n;
		var g = P.PlotUtils.getThirdPoint(o, e, Math.PI / 6, n, !1),
			i = P.PlotUtils.getThirdPoint(o, e, Math.PI / 6, n, !0);
		this.setCoordinates([o, e, g, e, i])
	}
}, P.Plot.Polyline = function(t) {
	goog.base(this, []), this.type = P.PlotTypes.POLYLINE, this.setPoints(t)
}, goog.inherits(P.Plot.Polyline, ol.geom.LineString), goog.mixin(P.Plot.Polyline.prototype, P.Plot.prototype), P.Plot.Polyline.prototype.generate = function() {
	var t = this.getPointCount();
	2 > t || this.setCoordinates(this.points)
}, P.Plot.FreehandLine = function(t) {
	goog.base(this, []), this.type = P.PlotTypes.FREEHAND_LINE, this.freehand = !0, this.setPoints(t)
}, goog.inherits(P.Plot.FreehandLine, ol.geom.LineString), goog.mixin(P.Plot.FreehandLine.prototype, P.Plot.prototype), P.Plot.FreehandLine.prototype.generate = function() {
	var t = this.getPointCount();
	2 > t || this.setCoordinates(this.points)
}, P.Plot.Polygon = function(t) {
	goog.base(this, []), this.type = P.PlotTypes.POLYGON, this.setPoints(t)
}, goog.inherits(P.Plot.Polygon, ol.geom.Polygon), goog.mixin(P.Plot.Polygon.prototype, P.Plot.prototype), P.Plot.Polygon.prototype.generate = function() {
	var t = this.getPointCount();
	2 > t || this.setCoordinates([this.points])
}, P.Plot.Marker = function(t) {
	goog.base(this, [0, 0]), this.type = P.PlotTypes.MARKER, this.fixPointCount = 1, this.setPoints(t)
}, goog.inherits(P.Plot.Marker, ol.geom.Point), goog.mixin(P.Plot.Marker.prototype, P.Plot.prototype), P.Plot.Marker.prototype.generate = function() {
	var t = this.points[0];
	this.setCoordinates(t)
}, P.Plot.Rectangle = function(t) {
	goog.base(this, []), this.type = P.PlotTypes.RECTANGLE, this.fixPointCount = 2, this.setPoints(t)
}, goog.inherits(P.Plot.Rectangle, ol.geom.Polygon), goog.mixin(P.Plot.Rectangle.prototype, P.Plot.prototype), P.Plot.Rectangle.prototype.generate = function() {
	var t = this.getPointCount();
	if(!(2 > t)) {
		var o = this.points[0],
			e = this.points[1],
...
}, P.Plot.FreehandPolygon = function(t) {
	goog.base(this, []), this.type = P.PlotTypes.FREEHAND_POLYGON, this.freehand = !0, this.setPoints(t)
}, goog.inherits(P.Plot.FreehandPolygon, ol.geom.Polygon), goog.mixin(P.Plot.FreehandPolygon.prototype, P.Plot.prototype), P.Plot.FreehandPolygon.prototype.generate = function() {
	var t = this.getPointCount();
	2 > t || this.setCoordinates([this.points])
}, P.PlotFactory = {}, P.PlotFactory.createPlot = function(t, o) {
	switch(t) {
		case P.PlotTypes.ARC:
			return new P.Plot.Arc(o);
		case P.PlotTypes.ELLIPSE:
			return new P.Plot.Ellipse(o);
		case P.PlotTypes.CURVE:
			return new P.Plot.Curve(o);
		case P.PlotTypes.CLOSED_CURVE:
			return new P.Plot.ClosedCurve(o);
		case P.PlotTypes.LUNE:
			return new P.Plot.Lune(o);
		case P.PlotTypes.SECTOR:
			return new P.Plot.Sector(o);
		case P.PlotTypes.GATHERING_PLACE:
			return new P.Plot.GatheringPlace(o);
		case P.PlotTypes.STRAIGHT_ARROW:
			return new P.Plot.StraightArrow(o);
		case P.PlotTypes.ASSAULT_DIRECTION:
			return new P.Plot.AssaultDirection(o);
		case P.PlotTypes.ATTACK_ARROW:
			return new P.Plot.AttackArrow(o);
		case P.PlotTypes.FINE_ARROW:
			return new P.Plot.FineArrow(o);
		case P.PlotTypes.CIRCLE:
			return new P.Plot.Circle(o);
		case P.PlotTypes.DOUBLE_ARROW:
			return new P.Plot.DoubleArrow(o);
		case P.PlotTypes.TAILED_ATTACK_ARROW:
			return new P.Plot.TailedAttackArrow(o);
		case P.PlotTypes.SQUAD_COMBAT:
			return new P.Plot.SquadCombat(o);
		case P.PlotTypes.TAILED_SQUAD_COMBAT:
			return new P.Plot.TailedSquadCombat(o);
		case P.PlotTypes.FREEHAND_LINE:
			return new P.Plot.FreehandLine(o);
		case P.PlotTypes.FREEHAND_POLYGON:
			return new P.Plot.FreehandPolygon(o);
		case P.PlotTypes.POLYGON:
			return new P.Plot.Polygon(o);
		case P.PlotTypes.MARKER:
			return new P.Plot.Marker(o);
		case P.PlotTypes.RECTANGLE:
			return new P.Plot.Rectangle(o);
		case P.PlotTypes.POLYLINE:
			return new P.Plot.Polyline(o)
	}
	return null
}, P.PlotDraw = function(t) {
	goog.base(this, []), this.points = null, this.plot = null, this.feature = null, this.plotType = null, this.plotParams = null, this.mapViewport = null, this.dblClickZoomInteraction = null;
	var o = new ol.style.Stroke({
			color: "#0099FF",
			width: 1.25
		}),
		e = new ol.style.Fill({
	...
	this.style = new ol.style.Style({
		fill: e,
		stroke: o
	}), this.featureSource = new ol.source.Vector, this.drawOverlay = new ol.layer.Vector({
		source: this.featureSource
	}), this.drawOverlay.setStyle(this.style), this.setMap(t)
}, goog.inherits(P.PlotDraw, ol.Observable), P.PlotDraw.prototype.activate = function(t, o) {
	this.deactivate(), this.deactivateMapTools(), this.map.on("click", this.mapFirstClickHandler, this), this.plotType = t, this.plotParams = o, this.map.addLayer(this.drawOverlay)
	}, P.PlotDraw.prototype.deactivate = function() {
	this.disconnectEventHandlers(), this.map.removeLayer(this.drawOverlay), this.featureSource.clear(), this.points = [], this.plot = null, this.feature = null, this.plotType = null, this.plotParams = null, this.activateMapTools()
}, P.PlotDraw.prototype.isDrawing = function() {
	return null != this.plotType
}, P.PlotDraw.prototype.setMap = function(t) {
	this.map = t, this.mapViewport = this.map.getViewport()
}, P.PlotDraw.prototype.mapFirstClickHandler = function(t) {
	return this.points.push(t.coordinate), this.plot = P.PlotFactory.createPlot(this.plotType, this.points, this.plotParams), this.feature = new ol.Feature(this.plot), this.featureSource.addFeature(this.feature), this.map.un("click", this.mapFirstClickHandler, this), this.plot.fixPointCount == this.plot.getPointCount() ? void this.mapDoubleClickHandler(t) : (this.map.on("click", this.mapNextClickHandler, this), this.plot.freehand || this.map.on("dblclick", this.mapDoubleClickHandler, this), void goog.events.listen(this.mapViewport, P.Event.EventType.MOUSEMOVE, this.mapMouseMoveHandler, !1, this))
}, P.PlotDraw.prototype.mapMouseMoveHandler = function(t) {
	var o = this.map.getCoordinateFromPixel([t.offsetX, t.offsetY]);
	if(!(P.PlotUtils.distance(o, this.points[this.points.length - 1]) < P.Constants.ZERO_TOLERANCE))
		if(this.plot.freehand) this.points.push(o), this.plot.setPoints(this.points);
		else {
			var e = this.points.concat([o]);
			this.plot.setPoints(e)
		}
}, P.PlotDraw.prototype.mapNextClickHandler = function(t) {
	return !this.plot.freehand && P.PlotUtils.distance(t.coordinate, this.points[this.points.length - 1]) < P.Constants.ZERO_TOLERANCE ? void 0 : (this.points.push(t.coordinate), this.plot.setPoints(this.points), this.plot.fixPointCount == this.plot.getPointCount() ? void this.mapDoubleClickHandler(t) : void(this.plot && this.plot.freehand && this.mapDoubleClickHandler(t)))
}, P.PlotDraw.prototype.mapDoubleClickHandler = function(t) {
	this.disconnectEventHandlers(), this.plot.finishDrawing(), t.preventDefault(), this.drawEnd()
}, P.PlotDraw.prototype.disconnectEventHandlers = function() {
	this.map.un("click", this.mapFirstClickHandler, this), this.map.un("click", this.mapNextClickHandler, this), goog.events.unlisten(this.mapViewport, P.Event.EventType.MOUSEMOVE, this.mapMouseMoveHandler, !1, this), this.map.un("dblclick", this.mapDoubleClickHandler, this)
}, P.PlotDraw.prototype.drawEnd = function(t) {
	this.featureSource.removeFeature(this.feature), this.activateMapTools(), this.disconnectEventHandlers(), this.map.removeOverlay(this.drawOverlay), this.points = [], this.plot = null, this.plotType = null, this.plotParams = null, this.dispatchEvent(new P.Event.PlotDrawEvent(P.Event.PlotDrawEvent.DRAW_END, this.feature)), this.feature = null
}, P.PlotDraw.prototype.deactivateMapTools = function() {
	for(var t = this.map.getInteractions(), o = t.getLength(), e = 0; o > e; e++) {
		var r = t.item(e);
		if(r instanceof ol.interaction.DoubleClickZoom) {
			this.dblClickZoomInteraction = r, t.remove(r);
			break
		}
	}
}, P.PlotDraw.prototype.activateMapTools = function() {
	null != this.dblClickZoomInteraction && (this.map.getInteractions().push(this.dblClickZoomInteraction), this.dblClickZoomInteraction = null)
}, P.PlotEdit = function(t) {
	t && (goog.base(this, []), this.activePlot = null, this.startPoint = null, this.ghostControlPoints = null, this.controlPoints = null, this.map = t, this.mapViewport = this.map.getViewport(), this.mouseOver = !1, this.elementTable = {}, this.activeControlPointId = null, this.mapDragPan = null)
}, goog.inherits(P.PlotEdit, ol.Observable), P.PlotEdit.prototype.Constants = {
	...
	if(this.map && this.activePlot) {
		var t = this.getMapParentElement();
		if(t)
			for(var o = P.DomUtils.createHidden("div", t, this.Constants.HELPER_HIDDEN_DIV), e = this.getControlPoints(), r = 0; r < e.length; r++) {
				var n = this.Constants.HELPER_CONTROL_POINT_DIV + "-" + r;
				P.DomUtils.create("div", this.Constants.HELPER_CONTROL_POINT_DIV, o, n), this.elementTable[n] = r
			}
	}
}, P.PlotEdit.prototype.getMapParentElement = function() {
	var t = this.map.getTargetElement();
	if(t) return t.parentNode
}, P.PlotEdit.prototype.destroyHelperDom = function() {
	if(this.controlPoints) {
		for(var t = 0; t < this.controlPoints.length; t++) {
			this.map.removeOverlay(this.controlPoints[t]);
			var o = P.DomUtils.get(this.Constants.HELPER_CONTROL_POINT_DIV + "-" + t);
			o && (P.DomUtils.removeListener(o, "mousedown", this.controlPointMouseDownHandler, this), P.DomUtils.removeListener(o, "mousemove", this.controlPointMouseMoveHandler2, this))
		}
		this.controlPoints = null
	}
	var e = this.getMapParentElement(),
		r = P.DomUtils.get(this.Constants.HELPER_HIDDEN_DIV);
	r && e && P.DomUtils.remove(r, e)
}, P.PlotEdit.prototype.initControlPoints = function() {
	if(this.map) {
		this.controlPoints = [];
		for(var t = this.getControlPoints(), o = 0; o < t.length; o++) {
			var e = this.Constants.HELPER_CONTROL_POINT_DIV + "-" + o,
				r = P.DomUtils.get(e),
				n = new ol.Overlay({
					id: e,
					position: t[o],
			...
			this.controlPoints.push(n), this.map.addOverlay(n), P.DomUtils.addListener(r, "mousedown", this.controlPointMouseDownHandler, this), P.DomUtils.addListener(r, "mousemove", this.controlPointMouseMoveHandler2, this)
		}
	}
}, P.PlotEdit.prototype.controlPointMouseMoveHandler2 = function(t) {
	t.stopImmediatePropagation()
}, P.PlotEdit.prototype.controlPointMouseDownHandler = function(t) {
	var o = t.target.id;
	this.activeControlPointId = o, goog.events.listen(this.mapViewport, P.Event.EventType.MOUSEMOVE, this.controlPointMouseMoveHandler, !1, this), goog.events.listen(this.mapViewport, P.Event.EventType.MOUSEUP, this.controlPointMouseUpHandler, !1, this)
}, P.PlotEdit.prototype.controlPointMouseMoveHandler = function(t) {
	var o = this.map.getCoordinateFromPixel([t.offsetX, t.offsetY]);
	if(this.activeControlPointId) {
		var e = this.activePlot.getGeometry(),
			r = this.elementTable[this.activeControlPointId];
		e.updatePoint(o, r);
		var n = this.map.getOverlayById(this.activeControlPointId);
		n.setPosition(o)
	}
}, P.PlotEdit.prototype.controlPointMouseUpHandler = function(t) {
	goog.events.unlisten(this.mapViewport, P.Event.EventType.MOUSEMOVE, this.controlPointMouseMoveHandler, !1, this), goog.events.unlisten(this.mapViewport, P.Event.EventType.MOUSEUP, this.controlPointMouseUpHandler, !1, this)
}, P.PlotEdit.prototype.activate = function(t) {
	if(t && t instanceof ol.Feature && t != this.activePlot) {
		var o = t.getGeometry();
		o.isPlot&&o.isPlot() && (this.deactivate(), this.activePlot = t, this.map.on("pointermove", this.plotMouseOverOutHandler, this), this.initHelperDom(), this.initControlPoints())
	}
}, P.PlotEdit.prototype.getControlPoints = function() {
	if(!this.activePlot) return [];
	var t = this.activePlot.getGeometry();
	return t.getPoints()
}, P.PlotEdit.prototype.plotMouseOverOutHandler = function(t) {
	var o = this.map.forEachFeatureAtPixel(t.pixel, function(t, o) {
		return t
	});
	o && o == this.activePlot ? this.mouseOver || (this.mouseOver = !0, this.map.getViewport().style.cursor = "move", this.map.on("pointerdown", this.plotMouseDownHandler, this)) : this.mouseOver && (this.mouseOver = !1, this.map.getViewport().style.cursor = "default", this.map.un("pointerdown", this.plotMouseDownHandler, this))
}, P.PlotEdit.prototype.plotMouseDownHandler = function(t) {
	this.ghostControlPoints = this.getControlPoints(), this.startPoint = t.coordinate, this.disableMapDragPan(), this.map.on("pointerup", this.plotMouseUpHandler, this), this.map.on("pointerdrag", this.plotMouseMoveHandler, this)
}, P.PlotEdit.prototype.plotMouseMoveHandler = function(t) {
	for(var o = t.coordinate, e = o[0] - this.startPoint[0], r = o[1] - this.startPoint[1], n = [], g = 0; g < this.ghostControlPoints.length; g++) {
		var i = this.ghostControlPoints[g],
			s = [i[0] + e, i[1] + r];
		n.push(s);
		var a = this.Constants.HELPER_CONTROL_POINT_DIV + "-" + g,
			l = this.map.getOverlayById(a);
		l.setPosition(s), l.setPositioning("center-center")
	}
	var u = this.activePlot.getGeometry();
	u.setPoints(n)
}, P.PlotEdit.prototype.plotMouseUpHandler = function(t) {
	this.enableMapDragPan(), this.map.un("pointerup", this.plotMouseUpHandler, this), this.map.un("pointerdrag", this.plotMouseMoveHandler, this)
}, P.PlotEdit.prototype.disconnectEventHandlers = function() {
	this.map.un("pointermove", this.plotMouseOverOutHandler, this), goog.events.unlisten(this.mapViewport, P.Event.EventType.MOUSEMOVE, this.controlPointMouseMoveHandler, !1, this), goog.events.unlisten(this.mapViewport, P.Event.EventType.MOUSEUP, this.controlPointMouseUpHandler, !1, this), this.map.un("pointerdown", this.plotMouseDownHandler, this), this.map.un("pointerup", this.plotMouseUpHandler, this), this.map.un("pointerdrag", this.plotMouseMoveHandler, this)
}, P.PlotEdit.prototype.deactivate = function() {
	this.activePlot = null, this.mouseOver = !1, this.destroyHelperDom(), this.disconnectEventHandlers(), this.elementTable = {}, this.activeControlPointId = null, this.startPoint = null
}, P.PlotEdit.prototype.disableMapDragPan = function() {
	for(var t = this.map.getInteractions(), o = t.getLength(), e = 0; o > e; e++) {
		var r = t.item(e);
		if(r instanceof ol.interaction.DragPan) {
			this.mapDragPan = r, r.setActive(!1);
			break
		}
	}
}, P.PlotEdit.prototype.enableMapDragPan = function() {
	null != this.mapDragPan && (this.mapDragPan.setActive(!0), this.mapDragPan = null)
};